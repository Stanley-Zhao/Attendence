...
namespace CARSEncropte
{
    class Program
    {
        static void Main(string[] args)
        {
			Console.WriteLine(CryptographyStuff.AES_DecryptString("68103bbdaad8b9aa9c7504644dadb4a7"));
            Console.WriteLine(CryptographyStuff.AES_EncryptString("a"));
            Console.ReadKey();
        }
    }
